/*
 * Based on the JLinkPluginRegistrationAgent class from hibernate-demos (https://github.com/hibernate/hibernate-demos)
...
public final class JLinkRegistrationAgent {
    public static final String MODULE_NAME = "edu.columbia.cs.psl.phosphor.driver";
    private static final String JLINK_MODULE_NAME = "jdk.jlink";
    private static final String JLINK_PLUGIN_PACKAGE_NAME = "jdk.tools.jlink.plugin";
    private static final String JLINK_PLUGIN_CLASS_NAME = JLINK_PLUGIN_PACKAGE_NAME + ".Plugin";
