#!/bin/sh
  ...
  --import $TRAVIS_BUILD_DIR/deployment/signingkey.asc
  cd $TRAVIS_BUILD_DIR/phosphor;
 mvn -DskipTests deploy --settings $TRAVIS_BUILD_DIR/deployment/settings.xml -Dgpg.executable=gpg2 -Dgpg.keyname=5F84CD1775351968CABF0B0D779D2423E1D24D89
