...
public class JLinkRegistrationAgent {
    public static void premain(String agentArgs, Instrumentation inst) throws Exception {
        ...
        Module phosphorModule = ModuleLayer.boot().findModule("edu.columbia.cs.psl.jigsaw.phosphor.instrumenter").get();
        ...
        Class<?> addPhosphorPluginClass = phosphorModule.getClassLoader().loadClass("edu.columbia.cs.psl.jigsaw.phosphor.instrumenter.PhosphorJLinkPlugin");
