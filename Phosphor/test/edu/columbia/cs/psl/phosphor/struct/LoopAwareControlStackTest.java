...
public class LoopAwareControlStackTest {
    ...
    public void testCopyTagDifferentLevels() {
        LoopAwareControlStack<Object> ctrl = new LoopAwareControlStack<>();
        ctrl.pushConstant(0, Taint.withLabel(0), 3);
        ctrl.pushVariant(1, Taint.withLabel(1), 3, 1);
        ctrl.pushConstant(2, Taint.withLabel(2), 3);
    ...
    public void testPushFramePushTag() {
        LoopAwareControlStack<Object> ctrl = new LoopAwareControlStack<>();
        ctrl.pushConstant(0, Taint.withLabel(0), 1);
        ctrl.startFrame(0, 0).pushFrame();
        ctrl.pushConstant(0, Taint.withLabel(1), 1);
    ...
    public void testPushFrameOffset() {
        ...
        ctrl.pushVariant(0, Taint.withLabel(1), 1, 0);
        assertContainsLabels(ctrl.copyTagConstant(), 0);
    ...
    public void testPopToFrame() {
        LoopAwareControlStack<Object> ctrl = new LoopAwareControlStack<>();
        ctrl.pushConstant(0, Taint.withLabel(0), 1);
        LoopAwareControlStack.LoopAwareControlFrame<Object> restorePoint = ctrl.startFrame(1, 0).pushFrameAndGetRestorePoint();
        ctrl.pushConstant(0, Taint.withLabel(1), 1);
        ctrl.startFrame(0, 0).pushFrame();
        ctrl.pushConstant(0, Taint.withLabel(2), 1);
