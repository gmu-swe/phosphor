#!/bin/bash
DACAPO_DIR=dacapo
PHOSPHOR_JAR=`pwd`/target/Phosphor-0.0.5-SNAPSHOT.jar
...
echo "target/jre-inst-obj/bin/java -Xbootclasspath/p:$PHOSPHOR_JAR -javaagent:$PHOSPHOR_JAR -cp target/dacapo-inst-obj/ -Declipse.java.home=$JAVA_HOME -Djava.awt.headless=true Harness $bm"
target/jre-inst-obj/bin/java -Xmx1g -Xbootclasspath/p:$PHOSPHOR_JAR -javaagent:$PHOSPHOR_JAR -cp target/dacapo-inst-obj/ -Declipse.java.home=$JAVA_HOME -Djava.awt.headless=true Harness $bm
if [ $? -ne 0 ]; then
