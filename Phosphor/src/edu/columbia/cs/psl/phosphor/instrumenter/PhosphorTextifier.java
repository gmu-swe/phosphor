...
public class PhosphorTextifier extends Textifier {
	...
	ublic static final int IS_TMP_STORE = 213;
	...
	public void visitVarInsn(int opcode, int var) {
		...
		{
	        buf.setLength(0);
	        buf.append(tab2).append(MORE_OPCODES[opcode-200]).append(opcode).append(' ').append(var).append('\n');
	...
	public void visitIntInsn(int opcode, int operand) {
		if(opcode > 200)
		{
			buf.setLength(0);
	        buf.append(tab2)
	                .append(MORE_OPCODES[opcode-200])
	                .append(' ')
