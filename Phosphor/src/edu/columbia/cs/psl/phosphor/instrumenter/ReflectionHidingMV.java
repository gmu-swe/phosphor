...
public class ReflectionHidingMV extends MethodVisitor implements Opcodes {
	...
	public ReflectionHidingMV(MethodVisitor mv, String className,
			String name, NeverNullArgAnalyzerAdapter analyzer) {
	...
	private static boolean shouldDisable(String className, String methodName) {
	    if(className.equals("org/codehaus/groovy/vmplugin/v5/Java5")
				&& methodName.equals("makeInterfaceTypes"))
	        return true;
	    return false;
	}
	...
	public void visitMethodInsn(int opcode, String owner,
			String name, String desc, boolean itfc) {
		...
		if ((owner.equals("java/lang/reflect/Method")
			...
			if (owner.equals("java/lang/reflect/Method")) {
				...
				if (!Instrumenter.IS_ANDROID_INST
						&& !Instrumenter.IS_KAFFE_INST
						&& !Instrumenter.IS_HARMONY_INST) {
					...
					super.visitMethodInsn(Opcodes.INVOKESTATIC,
							Type.getInternalName(ReflectionMasker.class),
							"fixAllArgsFast",
							"(Ljava/lang/reflect/Method;[Ljava/lang/Object;Z)[Ljava/lang/Object;",
							false);
					...
					super.visitMethodInsn(Opcodes.INVOKESTATIC,
							Type.getInternalName(ReflectionMasker.class),
							"fixAllArgs",
							"(Ljava/lang/reflect/Method;Ljava/lang/Object;[Ljava/lang/Object;Z)"
								+ Type.getDescriptor(MethodInvoke.class),
							false);
					//B
					super.visitInsn(Opcodes.DUP);
					//B B
					super.visitFieldInsn(Opcodes.GETFIELD,
							Type.getInternalName(MethodInvoke.class),
							"m",
				...
				if (Configuration.IMPLICIT_TRACKING) {
					...
					super.visitMethodInsn(Opcodes.INVOKESTATIC,
							Type.getInternalName(ReflectionMasker.class),
							"fixAllArgs",
							"([Ljava/lang/Object;Ljava/lang/reflect/Constructor;Z)[Ljava/lang/Object;",
							false);
				}
			}
			...
			if (args.length == 0) {
				...
				super.visitMethodInsn(Opcodes.INVOKESTATIC,
						Type.getInternalName(ReflectionMasker.class),
						"getOrigMethod",
						"(Ljava/lang/reflect/Method;Z)Ljava/lang/reflect/Method;",
						false);
			...
			if (args.length == 0) {
				...
				super.visitMethodInsn(Opcodes.INVOKESTATIC,
						Type.getInternalName(ReflectionMasker.class),
						"getOrigMethod",
						"(Ljava/lang/reflect/Constructor;Z)Ljava/lang/reflect/Constructor;",
						false);
			} else if (args.length == 1) {
				super.visitInsn(Opcodes.SWAP);
				super.visitInsn((Configuration.MULTI_TAINTING ? ICONST_1 : ICONST_0));
				...
				&& (((name.equals("getConstructor")
							|| (name.equals("getDeclaredConstructor")))
						&& args.length == 1)
			...
			if (args.length == 2) {
				...
				if (!Configuration.IMPLICIT_TRACKING) {
					desc = "(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;Z)"
						+ "Ljava/lang/reflect/Method;";
					super.visitInsn((Configuration.MULTI_TAINTING ? ICONST_1 : ICONST_0));
				}
			} else {
		...
		if (owner.equals("java/lang/reflect/Field")
				...
				&& (name.equals("get")
					|| name.equals("get$$PHOSPHORTAGGED")
					|| name.equals("set$$PHOSPHORTAGGED")
					|| name.equals("getInt$$PHOSPHORTAGGED")
					|| name.equals("getBoolean$$PHOSPHORTAGGED")
					|| name.equals("getChar$$PHOSPHORTAGGED")
					|| name.equals("getDouble$$PHOSPHORTAGGED")
					|| name.equals("getByte$$PHOSPHORTAGGED")
					|| name.equals("getFloat$$PHOSPHORTAGGED")
					|| name.equals("getLong$$PHOSPHORTAGGED")
					|| name.equals("getShort$$PHOSPHORTAGGED")
					|| name.equals("setAccessible$$PHOSPHORTAGGED")
					|| name.equals("set")
					|| name.equals("setInt$$PHOSPHORTAGGED")
					|| name.equals("setBoolean$$PHOSPHORTAGGED")
					|| name.equals("setChar$$PHOSPHORTAGGED")
					|| name.equals("setDouble$$PHOSPHORTAGGED")
					|| name.equals("setByte$$PHOSPHORTAGGED")
					|| name.equals("setFloat$$PHOSPHORTAGGED")
					|| name.equals("setLong$$PHOSPHORTAGGED")
					|| name.equals("setShort$$PHOSPHORTAGGED")
					|| name.equals("getType")
					|| name.equals("getType$$PHOSPHORTAGGED"))) {
			...
			if (name.equals("get")) {
				...
				super.visitInsn((Configuration.MULTI_TAINTING
							? Opcodes.ICONST_1
							: Opcodes.ICONST_0));
		...
		if (!Instrumenter.IS_ANDROID_INST
				...
				&& (name.equals("copyMethods")
					|| name.equals("copyFields")
					|| name.equals("copyConstructors"))) {
			owner = Type.getInternalName(ReflectionMasker.class);
		}
		...
		if (owner.equals("java/lang/Class")
				&& desc.endsWith("[Ljava/lang/reflect/Field;")
				&& !className.equals("java/lang/Class")) {
			if (Instrumenter.IS_ANDROID_INST && !Configuration.WITHOUT_FIELD_HIDING)
				...
				&& (desc.equals("()[Ljava/lang/reflect/Method;")
					|| desc.equals("(" + Type.getDescriptor(ControlTaintTagStack.class)
						+ ")[Ljava/lang/reflect/Method;"))) {
			if (Instrumenter.IS_ANDROID_INST)
				super.visitMethodInsn(Opcodes.INVOKESTATIC,
						Type.getInternalName(ReflectionMasker.class),
				...
				&& !className.equals(owner)
				&& (desc.equals("()[Ljava/lang/reflect/Constructor;")
					|| desc.equals("(" + Type.getDescriptor(ControlTaintTagStack.class)
						+ ")[Ljava/lang/reflect/Constructor;"))) {
			if (Instrumenter.IS_ANDROID_INST)
				super.visitMethodInsn(Opcodes.INVOKESTATIC,
						Type.getInternalName(ReflectionMasker.class),
						"removeTaintConstructors",
			...
			super.visitMethodInsn(Opcodes.INVOKESTATIC,
					Type.getInternalName(ReflectionMasker.class),
					"removeTaintedInterface",
					"([Ljava/lang/Class;)[Ljava/lang/Class;",
					false);
		} else if (owner.equals("java/lang/Throwable")
				&& (name.equals("getOurStackTrace")
					|| name.equals("getStackTrace"))
				&& desc.equals("()" + "[" + Type.getDescriptor(StackTraceElement.class))) {
			...
			super.visitMethodInsn(Opcodes.INVOKESTATIC,
					Type.getInternalName(ReflectionMasker.class),
					"removeExtraStackTraceElements",
					"(" + stackTraceElDesc + "Ljava/lang/Class;)" + stackTraceElDesc,
					false);
		...
		if ((owner.equals("java/lang/reflect/Method")
				...
				&& (name.equals("invoke")
					...
					|| name.equals("invoke$$PHOSPHORTAGGED")
			...
			super.visitTypeInsn(Opcodes.INSTANCEOF,
					Type.getInternalName((Configuration.MULTI_TAINTING
							? TaintedPrimitiveWithObjTag.class
							: TaintedPrimitiveWithIntTag.class)));
			...
			super.visitTypeInsn(Opcodes.INSTANCEOF,
					Type.getInternalName((Configuration.MULTI_TAINTING
							? TaintedPrimitiveArrayWithObjTag.class
							: TaintedPrimitiveArrayWithIntTag.class)));
