...
import edu.columbia.cs.psl.phosphor.runtime.JDTReflectionMasker;
...
public class ReflectionHidingMV extends MethodVisitor implements Opcodes {
	...
	public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itfc) {
		...
		if ((owner.equals("java/lang/reflect/Method") || owner.equals("java/lang/reflect/Constructor")) && (name.startsWith("invoke") || name.startsWith("newInstance"))) {
			...
			if (owner.equals("java/lang/reflect/Method")) {
				...
				if (!Instrumenter.IS_ANDROID_INST && !Instrumenter.IS_KAFFE_INST && !Instrumenter.IS_HARMONY_INST) {
					...
					if (TaintUtils.PREALLOC_RETURN_ARRAY) {
						super.visitVarInsn(ALOAD, preAllocVar);
						super.visitMethodInsn(Opcodes.INVOKESTATIC, Type.getInternalName(ReflectionMasker.class), "fixAllArgsFast",
								"(Ljava/lang/reflect/Method;[Ljava/lang/Object;Z"+Configuration.TAINTED_RETURN_HOLDER_DESC+")[Ljava/lang/Object;", false);
					} else
						super.visitMethodInsn(Opcodes.INVOKESTATIC, Type.getInternalName(ReflectionMasker.class), "fixAllArgsFast",
								"(Ljava/lang/reflect/Method;[Ljava/lang/Object;Z)[Ljava/lang/Object;", false);
					...
					if(TaintUtils.PREALLOC_RETURN_ARRAY){
						super.visitVarInsn(ALOAD, preAllocVar);
						super.visitMethodInsn(Opcodes.INVOKESTATIC, Type.getInternalName(ReflectionMasker.class), "fixAllArgs", "(Ljava/lang/reflect/Method;Ljava/lang/Object;[Ljava/lang/Object;Z"+Configuration.TAINTED_RETURN_HOLDER_DESC+")"
				...
				if (Configuration.IMPLICIT_TRACKING) {
					...
					if(TaintUtils.PREALLOC_RETURN_ARRAY)
					{
						...
						super.visitMethodInsn(Opcodes.INVOKESTATIC, Type.getInternalName(ReflectionMasker.class), "fixAllArgs",
								"([Ljava/lang/Object;Ljava/lang/reflect/Constructor;Z"+Configuration.TAINTED_RETURN_HOLDER_DESC+")[Ljava/lang/Object;", false);
						super.visitVarInsn(Opcodes.ALOAD, lvs.lvOfSingleWrapperArray);
					}
					else
					{
		...
		} else if ((owner.equals("java/lang/reflect/Method")) && name.startsWith("get") && !className.equals(owner) && (!className.startsWith("sun/reflect") || className.equals("sun/reflect/annotation/AnnotationType")) && !className.startsWith("java/lang/Class")) {
			if (args.length == 0)
			{
				super.visitInsn((Configuration.MULTI_TAINTING ? ICONST_1 : ICONST_0));
			...
			{
				super.visitVarInsn(Opcodes.ALOAD, lvs.lvOfSingleWrapperArray);
				super.visitMethodInsn(Opcodes.INVOKESTATIC, Type.getInternalName(ReflectionMasker.class), "getOrigMethod", "(Ljava/lang/reflect/Constructor;"+Configuration.TAINTED_RETURN_HOLDER_DESC+")Ljava/lang/reflect/Constructor;", false);
			}
			else if(args.length == 1){
				super.visitInsn(Opcodes.SWAP);
        super.visitVarInsn(Opcodes.ALOAD, lvs.lvOfSingleWrapperArray);
		...
		if (owner.equals("java/lang/Class") && desc.endsWith("[Ljava/lang/reflect/Field;") && !className.equals("java/lang/Class")) {
			if (Instrumenter.IS_ANDROID_INST && !Configuration.WITHOUT_FIELD_HIDING)
				...
				desc.equals("("+Type.getDescriptor(ControlTaintTagStack.class)+")[Ljava/lang/reflect/Method;")
				|| desc.equals("("+Configuration.TAINTED_RETURN_HOLDER_DESC+")[Ljava/lang/reflect/Method;"))) {
			if (Instrumenter.IS_ANDROID_INST)
				...
				|| desc.equals("("+Configuration.TAINTED_RETURN_HOLDER_DESC+")[Ljava/lang/reflect/Constructor;"))
				) {
			if (Instrumenter.IS_ANDROID_INST)
      ...
      super.visitVarInsn(Opcodes.ALOAD, lvs.lvOfSingleWrapperArray);
			super.visitMethodInsn(Opcodes.INVOKESTATIC, Type.getInternalName(ReflectionMasker.class), "removeTaintClass", "(Ljava/lang/Class;"+Configuration.TAINTED_RETURN_HOLDER_DESC+")Ljava/lang/Class;", false);
		}
