...
public final class MultiDTaintedDoubleArray extends MultiDTaintedArray implements Serializable {
	...
	public MultiDTaintedDoubleArray(int[] taint, double[] val) {
	...
	@Override
	public Object clone() {
		return new MultiDTaintedDoubleArray(taint.clone(), val.clone());
	}
