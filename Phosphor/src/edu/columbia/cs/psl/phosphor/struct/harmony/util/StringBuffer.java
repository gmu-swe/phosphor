...
public final class StringBuffer extends AbstractStringBuilder implements
     ...
     *
     * @param string the string content with which to initialize the new instance.
     ...
     *
     * @param cs the content to initialize the instance.
     ...
     *
     * @param string the string to append (may be null).
     * @return this StringBuffer.
     */
     ...
     * appended.
     *
     * @param sb the StringBuffer to append (may be null).
     * @return this StringBuffer.
     * @since 1.4
     */
     ...
     * @return this StringBuffer.
     * @throws ArrayIndexOutOfBoundsException if {@code length < 0} , {@code start < 0} or {@code start +
     *                                        length > chars.length}.
     * @throws NullPointerException           if {@code chars} is {@code null}.
     */
     ...
     * @return this StringBuffer.
     * @throws StringIndexOutOfBoundsException if {@code start < 0}, {@code start > end} or {@code end >
     *                                         length()}.
     */
     ...
     * @return this StringBuffer.
     * @throws StringIndexOutOfBoundsException if {@code location < 0} or {@code location >= length()}
     */
     ...
     * @throws IndexOutOfBoundsException if {@code start < 0}, {@code end > length()}, {@code start >
     ...
     * @return this buffer.
     * @throws StringIndexOutOfBoundsException if {@code index < 0} or {@code index > length()}.
     */
     ...
     *
     * @param index the index at which to insert.
     * @param obj   the object to insert (may be null).
     * @return this buffer.
     * @throws StringIndexOutOfBoundsException if {@code index < 0} or {@code index > length()}.
     */
     ...
     *
     * @param index  the index at which to insert.
     * @param string the string to insert (may be null).
     * @return this buffer.
     * @throws StringIndexOutOfBoundsException if {@code index < 0} or {@code index > length()}.
     */
     ...
     * @return this buffer.
     * @throws NullPointerException            if {@code chars} is {@code null}.
     * @throws StringIndexOutOfBoundsException if {@code length < 0}, {@code start < 0}, {@code start +
     ...
     *
     * @param index The index at which to insert.
     * @param s     The char sequence to insert.
     * @return this buffer.
     ...
     * @param index The index at which to insert.
     * @param s     The char sequence to insert.
     * @param start The inclusive start index in the char sequence.
     * @param end   The exclusive end index in the char sequence.
     * @return this buffer.
     * @throws IndexOutOfBoundsException if {@code index} is negative or greater than the current
     ...
     * @param end    the exclusive end index.
     * @param string the string that will replace the contents in the range.
     * @return this buffer.
     * @throws StringIndexOutOfBoundsException if {@code start} or {@code end} are negative, {@code start}
     *                                         is greater than {@code end} or {@code end} is greater than
     *                                         the length of {@code s}.
     */
