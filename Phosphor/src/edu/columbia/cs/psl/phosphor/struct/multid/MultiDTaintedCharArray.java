...
public final class MultiDTaintedCharArray extends MultiDTaintedArray implements Serializable {

	private static final long serialVersionUID = -6808286317985074403L;
	public char[] val;

	public MultiDTaintedCharArray() {
		super(null, Type.CHAR);
	}

	public MultiDTaintedCharArray(int[] taint, char[] val) {
	...
	@Override
	public Object clone() {
		return new MultiDTaintedCharArray(taint.clone(), val.clone());
	}
