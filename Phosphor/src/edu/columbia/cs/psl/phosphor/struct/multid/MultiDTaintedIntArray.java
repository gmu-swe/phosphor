...
public final class MultiDTaintedIntArray extends MultiDTaintedArray implements Serializable {

	public int[] val;

	public MultiDTaintedIntArray(int[] taint, int[] val) {
	...
	@Override
	public Object clone() {
		return new MultiDTaintedIntArray(taint.clone(), val.clone());
	}
