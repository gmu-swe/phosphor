...
public final class MultiDTaintedFloatArrayWithObjTag extends MultiDTaintedArrayWithObjTag implements Serializable {
	...
	public MultiDTaintedFloatArrayWithObjTag(LazyArrayObjTags taint, float[] val) {
	...
	@Override
	public Object clone() {
		return new MultiDTaintedFloatArrayWithObjTag((LazyArrayObjTags) taint.clone(), val.clone());
	}
