...
public final class MultiDTaintedCharArrayWithSingleObjTag extends MultiDTaintedArrayWithSingleObjTag implements Serializable {

	private static final long serialVersionUID = -6808286317985074403L;
	public char[] val;

	public MultiDTaintedCharArrayWithSingleObjTag() {
		super(null, Type.CHAR);
	}

	public MultiDTaintedCharArrayWithSingleObjTag(Object taint, char[] val) {
	...
	@Override
	public Object clone() {
		return new MultiDTaintedCharArrayWithSingleObjTag(taint, val.clone());
	}
