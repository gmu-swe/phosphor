...
public final class MultiDTaintedFloatArray extends MultiDTaintedArray implements Serializable {
	...
	public MultiDTaintedFloatArray(int[] taint, float[] val) {
	...
	@Override
	public Object clone() {
		return new MultiDTaintedFloatArray(taint.clone(), val.clone());
	}
