...
public final class MultiDTaintedLongArrayWithIntTag extends MultiDTaintedArrayWithIntTag implements Serializable {
	...
	public MultiDTaintedLongArrayWithIntTag(LazyArrayIntTags taint, long[] val) {
	...
	@Override
	public Object clone() {
		return new MultiDTaintedLongArrayWithIntTag((LazyArrayIntTags) taint.clone(), val.clone());
	}
