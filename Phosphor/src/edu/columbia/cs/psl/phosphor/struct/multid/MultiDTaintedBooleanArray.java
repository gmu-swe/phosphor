...
public final class MultiDTaintedBooleanArray extends MultiDTaintedArray implements Serializable {
	/**
	 * 
	 */
	...
	public MultiDTaintedBooleanArray(int[] taint, boolean[] val) {
	...
	@Override
	public Object clone() {
		return new MultiDTaintedBooleanArray(taint.clone(), val.clone());
	}
