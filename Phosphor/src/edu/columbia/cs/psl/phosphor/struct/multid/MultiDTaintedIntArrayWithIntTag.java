...
public final class MultiDTaintedIntArrayWithIntTag extends MultiDTaintedArrayWithIntTag implements Serializable {
	...
	public MultiDTaintedIntArrayWithIntTag(LazyArrayIntTags taint, int[] val) {
	...
	@Override
	public Object clone() {
		return new MultiDTaintedIntArrayWithIntTag((LazyArrayIntTags) taint.clone(), val.clone());
	}
