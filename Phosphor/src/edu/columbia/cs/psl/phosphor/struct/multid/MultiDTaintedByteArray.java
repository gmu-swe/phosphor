...
public final class MultiDTaintedByteArray extends MultiDTaintedArray implements Serializable {
	...
	public MultiDTaintedByteArray(int[] taint, byte[] val) {
	...
	@Override
	public Object clone() {
		return new MultiDTaintedByteArray(taint.clone(), val.clone());
	}
