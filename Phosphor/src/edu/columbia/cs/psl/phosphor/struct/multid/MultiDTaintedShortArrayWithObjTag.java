...
public final class MultiDTaintedShortArrayWithObjTag extends MultiDTaintedArrayWithObjTag implements Serializable{
	...
	public short[] val;
	public MultiDTaintedShortArrayWithObjTag(LazyArrayObjTags taint, short[] val) {
	...
	@Override
	public Object clone() {
		return new MultiDTaintedShortArrayWithObjTag((LazyArrayObjTags) taint.clone(), val.clone());
	}
