...
public final class MultiDTaintedShortArray extends MultiDTaintedArray implements Serializable{
	...
	public short[] val;
	public MultiDTaintedShortArray(int[] taint, short[] val) {
	...
	@Override
	public Object clone() {
		return new MultiDTaintedShortArray(taint.clone(), val.clone());
	}
