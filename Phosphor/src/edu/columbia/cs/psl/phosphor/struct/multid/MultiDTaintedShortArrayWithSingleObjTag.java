...
public final class MultiDTaintedShortArrayWithSingleObjTag extends MultiDTaintedArrayWithSingleObjTag implements Serializable{
	...
	public short[] val;
	public MultiDTaintedShortArrayWithSingleObjTag(Object taint, short[] val) {
	...
	@Override
	public Object clone() {
		return new MultiDTaintedShortArrayWithSingleObjTag(taint, val.clone());
	}
