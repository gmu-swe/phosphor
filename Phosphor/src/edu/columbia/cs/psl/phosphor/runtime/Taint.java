...
public final class Taint {
	...
	public TaintedBooleanWithObjTag hasNoDependencies$$PHOSPHORTAGGED(
	...
	public static void combineTagsOnObject(Object o, ControlTaintTagStack tags) {
		...
		if (o instanceof TaintedWithObjTag) {
			if (o instanceof String) {
				...
				((TaintedWithObjTag) o).setPHOSPHOR_TAG(
					Taint.combineTags((Taint) ((TaintedWithObjTag)o).getPHOSPHOR_TAG(), tags));
		}
	}
}
