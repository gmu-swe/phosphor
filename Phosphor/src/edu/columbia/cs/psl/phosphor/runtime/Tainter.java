...
public class Tainter {
	...
	public static TaintedShortWithIntTag taintedShort$$PHOSPHORTAGGED(int i, short s, int z, int tag,
			TaintedShortWithIntTag ret) {
		ret.taint = tag;
		ret.val = s;
		return ret;
	}
	...
	public static TaintedDoubleWithIntTag taintedDouble$$PHOSPHORTAGGED(int i, double s, int z, int tag,
			TaintedDoubleWithIntTag ret) {
		ret.taint = tag;
		ret.val = s;
		return ret;
	}
	...
	public static TaintedFloatWithIntTag taintedFloat$$PHOSPHORTAGGED(int i, float s, int z, int tag,
			TaintedFloatWithIntTag ret) {
		ret.taint = tag;
		ret.val = s;
		return ret;
	}
	...
	public static TaintedBooleanWithIntTag taintedBoolean$$PHOSPHORTAGGED(int i, boolean s, int z, int tag,
			TaintedBooleanWithIntTag ret) {
		ret.taint = tag;
		ret.val = s;
		return ret;
	}
	...
	public static TaintedCharArrayWithIntTag taintedCharArray$$PHOSPHORTAGGED(int[] oldCA, char[] ca, int b, int tag,
			TaintedCharArrayWithIntTag ret) {
		ret.val = ca;
	...
	public static TaintedBooleanArrayWithIntTag taintedBooleanArray$$PHOSPHORTAGGED(int[] oldCA, boolean[] ca, int b, int tag,
			TaintedBooleanArrayWithIntTag ret) {
		ret.val = ca;
		ret.taint = new int[ca.length];
		for(int i = 0; i < ca.length; i++)
			ret.taint[i] = tag;
	...
	public static TaintedByteArrayWithIntTag taintedByteArray$$PHOSPHORTAGGED(int[] oldCA, byte[] ca, int b, int tag,
			TaintedByteArrayWithIntTag ret) {
		ret.val = ca;
		ret.taint = new int[ca.length];
		for(int i = 0; i < ca.length; i++)
			ret.taint[i] = tag;
	...
	public static TaintedDoubleArrayWithIntTag taintedDoubleArray$$PHOSPHORTAGGED(int[] oldCA, double[] ca, int b, int tag,
			TaintedDoubleArrayWithIntTag ret) {
		ret.val = ca;
		ret.taint = new int[ca.length];
		for(int i = 0; i < ca.length; i++)
			ret.taint[i] = tag;
	...
	public static TaintedFloatArrayWithIntTag taintedFloatArray$$PHOSPHORTAGGED(int[] oldCA, float[] ca, int b, int tag,
			TaintedFloatArrayWithIntTag ret) {
		ret.val = ca;
		ret.taint = new int[ca.length];
		for(int i = 0; i < ca.length; i++)
			ret.taint[i] = tag;
	...
	public static TaintedIntArrayWithIntTag taintedIntArray$$PHOSPHORTAGGED(int[] oldCA, int[] ca, int b, int tag,
			TaintedIntArrayWithIntTag ret) {
		ret.val = ca;
		ret.taint = new int[ca.length];
		for(int i = 0; i < ca.length; i++)
			ret.taint[i] = tag;
	...
	public static TaintedLongArrayWithIntTag taintedLongArray$$PHOSPHORTAGGED(int[] oldCA, long[] ca, int b, int tag,
			TaintedLongArrayWithIntTag ret) {
		ret.val = ca;
		ret.taint = new int[ca.length];
		for(int i = 0; i < ca.length; i++)
			ret.taint[i] = tag;
	...
	public static TaintedShortArrayWithIntTag taintedShortArray$$PHOSPHORTAGGED(int[] oldCA, short[] ca, int b, int tag,
			TaintedShortArrayWithIntTag ret) {
		ret.val = ca;
		ret.taint = new int[ca.length];
		for(int i = 0; i < ca.length; i++)
			ret.taint[i] = tag;
	...
	public static TaintedByteWithIntTag taintedByte$$PHOSPHORTAGGED(int curTag, byte i, int tagTaint, int tag,
			TaintedByteWithIntTag ret) {
		ret.taint = tag;
		ret.val = i;
		return ret;
	}

	public static TaintedIntWithIntTag taintedInt$$PHOSPHORTAGGED(int curTag, int i, int tagTaint, int tag,
	...
	public static TaintedCharWithIntTag taintedChar$$PHOSPHORTAGGED(int curTag, char c, int tagTaint, int tag,
			TaintedCharWithIntTag ret) {
		ret.taint = tag;
		ret.val =c;
		return ret;
	}
	...
	public static TaintedLongWithIntTag taintedLong$$PHOSPHORTAGGED(int curTag, long c, int tagTaint, int tag,
			TaintedLongWithIntTag ret) {
		ret.taint = tag;
		ret.val =c;
		return ret;
	}
