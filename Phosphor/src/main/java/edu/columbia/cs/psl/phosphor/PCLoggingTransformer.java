...
public final class PCLoggingTransformer extends PhosphorBaseTransformer {
    ...
    static byte[] instrumentWithRetry(ClassReader cr, byte[] classFileBuffer, boolean isiFace, String className,
        ...
        try {
            try {
                ...
                if (!traceClass && (Phosphor.DEBUG || TaintUtils.VERIFY_CLASS_GENERATION)) {
            ...
            Phosphor.INSTRUMENTATION_EXCEPTION_OCCURRED = true;
            if (!traceClass) {
